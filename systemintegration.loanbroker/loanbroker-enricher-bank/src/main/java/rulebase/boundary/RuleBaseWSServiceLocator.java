...
public class RuleBaseWSServiceLocator extends org.apache.axis.client.Service
		implements rulebase.boundary.RuleBaseWSService {
	...
	public RuleBaseWSServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
	...
	public rulebase.boundary.RuleBaseWS getRuleBaseWSPort(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			rulebase.boundary.RuleBaseWSPortBindingStub _stub = new rulebase.boundary.RuleBaseWSPortBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (rulebase.boundary.RuleBaseWS.class.isAssignableFrom(serviceEndpointInterface)) {
				rulebase.boundary.RuleBaseWSPortBindingStub _stub = new rulebase.boundary.RuleBaseWSPortBindingStub(
						new java.net.URL(RuleBaseWSPort_address), this);
				_stub.setPortName(getRuleBaseWSPortWSDDServiceName());
				return _stub;
			}
